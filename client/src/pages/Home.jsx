    ...
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#0f1117] font-display transition-colors duration-500 overflow-x-hidden">
      ...
      <section className="relative pt-20 pb-32 px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="mt-10 flex items-center justify-center gap-6 text-sm font-bold text-slate-500 dark:text-slate-400 flex-wrap">
      ...
      <section className="py-24 bg-white dark:bg-slate-900 border-y border-slate-100 dark:border-slate-800/50 relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6">
            {categories.map((cat, idx) => (
              <Link key={idx} to={`/services?category=${cat.name}`} className="group bg-white dark:bg-slate-900 rounded-3xl p-6 text-center shadow-sm border border-slate-200/50 dark:border-slate-800 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-2 transition-all duration-300">
      ...
      {/* --- NEW: WHY CHOOSE US --- */}
      <section className="py-20 bg-slate-100 dark:bg-[#11131a] relative z-10 border-y border-slate-200 dark:border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative h-[500px] rounded-[3rem] overflow-hidden shadow-2xl border-4 border-white dark:border-slate-800">
          ...
          {featuredPros.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredPros.map((pro) => (
                <div key={pro._id} className="group flex flex-col bg-white dark:bg-slate-900 rounded-[2rem] overflow-hidden shadow-md border border-slate-200/60 dark:border-slate-800 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-2 transition-all duration-500">
      ...
      <section className="py-20 relative z-10 px-4">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-slate-900 to-slate-800 dark:from-primary dark:to-blue-900 rounded-[3rem] p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
